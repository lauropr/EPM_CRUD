		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tra0399epm0399-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tra0399epm0399-display": {
								"semanticObject": "tra0399epm0399",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tra0399.epm0399",
									"url": sap.ui.require.toUrl("tra0399/epm0399")
								}
							}
						}
					}
